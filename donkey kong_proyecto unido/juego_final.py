...
def seleccionar_personaje():
    ...
    texto5 = fuente_instrucciones.render("chocado 3 veces con el raton que  ", True, NEGRO)
    texto6 = fuente_instrucciones.render("aparece en la pantalla. ", True, NEGRO)
    texto7 = fuente_instrucciones.render("Utilice letra Q= para saltar ", True, NEGRO)
    texto8 = fuente_instrucciones.render("despace con las teclas direccionales ", True, NEGRO)
    ...
    texto11 = fuente_instrucciones.render("letra m pausa sonido"
                                          "JUGAR = Y", True, NEGRO)
...
def pausa():
    ...
    pausatext = fuente_instrucciones.render("JUEGO PAUSADO", True, NEGRO)
    instrcpausa=fuente_instrucciones.render("Presione C para continuar y X para salir",True,NEGRO)
    screen.blit(pausatext,[100,100])
    screen.blit(instrcpausa,[100,130])
    pygame.display.update()
    reloj.tick(1)
...
def mostrar_puntajes():
    ...
    archivo.write("Jugador 1: ..\n")
    archivo.write("Jugador 2: ..\n")
    archivo.write("Jugador 3: ..\n")
    archivo.close()
    ...
    with open("puntajes.txt") as f:
        ...
        screen.blit(instructText,[250,200])
